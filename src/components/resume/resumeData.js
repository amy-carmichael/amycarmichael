...
export const CERTIFICATIONS = [
  { title: 'Fullstory', sub: 'Fundamental Product Certification', meta: 'May 2024' },
  { title: 'General Assembly', sub: 'HTML, CSS, and JavaScript Circuit', meta: 'Aug 2022' },
  { title: 'Google', sub: 'UX Design Certificate', meta: 'Aug 2022' },
];
